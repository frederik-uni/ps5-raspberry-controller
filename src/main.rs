...
use interface::{ButtonsByte5, ControllerState};
...
impl DualSenseController {
    ...
    async fn initialize_bluetooth(&self) -> bluer::Result<()> {
...
async fn main() -> bluer::Result<()> {
    ...
    controller.initialize_bluetooth().await?;
    ...
    controller.update_state(|state| {
        state.buttons_5 = ButtonsByte5::CIRCLE;
    });
